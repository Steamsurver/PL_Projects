package org.engine.Rendering.Assets.Texture;
//Отвечает за то, какую мы текстуру выбрали
...
public class PickingTexture {
    ...
    private int fbo; //id frameBuffer-а
    ...
    public boolean init(int width, int height) {
        ...
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D,
                this.pickingTextureID, 0);//передаем текстуру буфферу
