...
import org.engine.Resources.Utils.JMath;
...
public class DebugDraw {
    ...
    // 6 переменный для вершины(x, y, z, r, g, b), 2 вершины на линию
    private static float[] vertexArray = new float[MAX_LINES * 6 * 2];
    private static Shader shader = AssetsPool.getShader("src/main/java/org/engine/Rendering/Shaders/lineShader.glsl");
