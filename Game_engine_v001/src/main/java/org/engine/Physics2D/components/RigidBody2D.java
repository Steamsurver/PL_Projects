...
import org.engine.Physics2D.enums.BodyType;
...
public class RigidBody2D extends Component {
    ...
    private transient Body rawBody = null;//обёрточный тип для синхронезированной передачи


    @Override
    public void update(float dt){
        if(rawBody != null){
            //передаем параметры оберточного тела нашему объекту
