...
public class GlobalVariable {
   public static EventManager eventManager = new EventManager();
    ...
    public static Dimension MonitorSize = Toolkit.getDefaultToolkit ().getScreenSize ();


    public static Font main_font = Font.loadFont("file:src/Textures/Font/PressStart2P-Regular.ttf", 30);
    public static Font small_main_font = Font.loadFont("file:src/Textures/Font/PressStart2P-Regular.ttf", 12);
    ...
    public static void setSetting(Stage stage){//установка начальных настроек
